...
Bg96Modem::Bg96Modem (Usart &u, Gpio &pwrKey, Gpio &status, Callback *c)
...
void Bg96Modem::power (bool on) {}

/*****************************************************************************/

bool Bg96Modem::connect (const char *address, uint16_t port)
{
...
void Bg96Modem::disconnect (int connectionId) {}

/*****************************************************************************/

int Bg96Modem::send (int connectionNumber, uint8_t *data, size_t len) { return dataToSendBuffer.store (data, len); }
